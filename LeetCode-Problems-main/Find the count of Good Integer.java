class Solution {
    ...
    // \U0001f522 A helper function to calculate factorial of a number (used for permutations)
    ...
    // \U0001f300 This function recursively generates all palindromic numbers of length 'n'
    ...
    // \U0001f3af This is the main function that returns the final answer
    public long countGoodIntegers(int n, int k) {
        ...
        // \U0001f9ee For each valid palindrome, generate a "frequency pattern" string
        for (String palindrome : validPalindromes) {
            ...
            // \U0001f9f5 Convert frequency into a pattern string (like a hash)
        ...
        for (String pattern : uniquePatterns) {
            ...
            // \U0001f9e9 Divide by factorials of repeated digits to handle duplicates (like permutations with repeated elements)
